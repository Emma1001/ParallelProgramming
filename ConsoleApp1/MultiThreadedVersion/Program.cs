...
namespace MultiThreadedVersion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Thread firstThread = new Thread(GetWordsArray);
            firstThread.Start();

            Thread secondThread = new Thread(GetShortestWord);
            secondThread.Start();

            Thread thirdThread = new Thread(GetLongestWord);
            thirdThread.Start();

            Thread fourthThread = new Thread(GetAverageWordLength);
            fourthThread.Start();

            Thread fifthThread = new Thread(GetFiveMostCommonWords);
            fifthThread.Start();

            Thread sixthThread = new Thread(GetFiveLeastCommonWords);
            sixthThread.Start();
